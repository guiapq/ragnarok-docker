...
> **Objetivo**: Avaliar e prototipar um pacote de assets 100% open-source/livre, reduzindo o client de ~3 GB para ~20 MB e eliminando qualquer dependência de arquivos proprietários de terceiros.
