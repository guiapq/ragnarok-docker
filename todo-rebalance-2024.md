# TODO: Rebalanceamento de Transclasses e Ninjas (Patch 2024 / Class Improvement)

Documento de planejamento, mapeamento e acompanhamento de execução das alterações trazidas no pacote de rebalanceamento de 2024 (baseado no *Transcendent & Expanded Class Improvement Project*).

---

## 1. Visão Geral da Pesquisa Comunitária

- **Origem do Patch**: As especificações correspondem ao rebalanceamento de Transclasses e Ninjas aplicado em **fevereiro/março de 2024** (*A Caminho das Classes 4*).
- **Existe um patch pré-pronto na comunidade de emulação BR?**:
